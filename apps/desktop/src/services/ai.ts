...
export const generateInterviewPreparation = (applicationId: string) => invoke<StoredInterviewPreparation>("generate_interview_preparation", { applicationId });
export const getLatestInterviewPreparation = (applicationId: string) => invoke<StoredInterviewPreparation | null>("get_latest_interview_preparation", { applicationId });
export const listApplicationAiCalls = (applicationId: string) => invoke<AiCallSummary[]>("list_application_ai_calls", { applicationId });
export const generateResumeQuestions = (applicationId: string, count: number) => invoke<PredictedQuestion[]>("generate_resume_questions", { applicationId, count });
