...
export const applications: Application[] = [
  ...
  { id: "bytedance", company: "字节跳动", companyMark: "字", role: "研发工程师", city: "北京", stage: "一面通过", stageTone: "green", priority: "普通", nextStep: "等待二面安排", nextTime: "待安排", progress: 3, updated: "5 月 19 日", resumeProfileId: "resume-backend", resumeName: "Java 后端 · 2026 秋招" },
