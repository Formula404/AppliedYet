...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::interviews::get_question_bank_item,
            commands::interviews::save_question_bank_item,
            commands::interviews::delete_question_bank_item,
            commands::interviews::archive_question_bank_item,
            commands::interviews::restore_question_bank_item,
            commands::interviews::list_question_match_candidates,
            commands::interviews::resolve_question_match,
            commands::interviews::merge_question_bank_items,
            commands::interviews::split_question_bank_item,
            commands::interviews::undo_question_merge,
